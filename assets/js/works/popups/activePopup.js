...
const active = (obj) => {
    const popupElement = new Popup(popup[obj].targetPopup,popup[obj].title,popup[obj].badgesPopup, popup[obj].webm, popup[obj].png, popup[obj].live, popup[obj].source, popup[obj].description);
